...
\FieldEndl{
    ...
    & \CondEnd\\
    & \FieldEndl{
        & \forall x\in X\diagdown \text{Closure}(X,\tau)(E):(\Rarrow)
    }{\;\;}{
        & \CondEnd\\
...
\FieldEndl{
    ...
    & \forall {\cal V}\in \Pow(\tau_Y):(\Rarrow)
}{\;\;}{
    & \CondBegin\\
    & \bigcup_{V\in {\cal V}} V\supe K\\
    & \CondEnd\\
