...
| [基数的定义](代数-关系-序数和基数#基数的定义)       | 基数的定义 $\text{card}$ <br /> 基数的比较 $\preceq$                                                                                                              |
