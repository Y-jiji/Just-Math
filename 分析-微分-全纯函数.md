...
:: \Field{(\and)}{\;\;}{
    ...
    & \forall \varepsilon\in ((0,\infin)):
        ...
        (\underset{\C}{x\to p}):
        x\in E \Rarrow |f(x) - y| < \varepsilon\\
}
\end{aligned}
\\
\begin{aligned}
    & ::: \exist E\in \Pow(\C): f:E\to \C\\
    & ::: (<):=(\overset\R<)\\
    & ::: q-p:=\underset{\C}{(q-p)}
\end{aligned}
\end{matrix}
...
\FieldEndl{
    ...
    & \CondEnd\\
    & \FieldEndl{
        & \forall \text{rect-curve}(\gamma):(\Rarrow)\\
    }{\;\;}{
        & \CondBegin\\
        & [a, b]::\gamma: [a, b]\to \C\\
